...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('90N9OTwWPR', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pw7t7oQAsk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, ['debug' => true, 'strict_variables' => true, 'cache' => false, 'autoescape' => 'name', 'charset' => 'UTF-8']);
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('telaXMF6gF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oLoaxOY32J', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JyOBkVbByW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e05e686ea8026f0bdbd91b6839f175aa80ce9baa'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/TranslationBundle/Resources/views'), 'bsCoreTranslation');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/TranslationBundle/Resources/views'), '!bsCoreTranslation');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/UsersBundle/Resources/views'), 'bsCoreUsers');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/UsersBundle/Resources/views'), '!bsCoreUsers');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/AdminBundle/Resources/views'), 'bsCoreAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/bs/Core/AdminBundle/Resources/views'), '!bsCoreAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/ArchiveBundle/Resources/views'), 'bsIDPArchive');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/ArchiveBundle/Resources/views'), '!bsIDPArchive');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/BackofficeBundle/Resources/views'), 'bsIDPBackoffice');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/BackofficeBundle/Resources/views'), '!bsIDPBackoffice');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/DashboardBundle/Resources/views'), 'bsIDPDashboard');
        $instance->addPath(($this->targetDirs[3].'/src/bs/IDP/DashboardBundle/Resources/views'), '!bsIDPDashboard');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e05e686ea8026f0bdbd91b6839f175aa80ce9baa');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings([0 => ($this->targetDirs[3].'/src/bs/IDP/ArchiveBundle/Resources/config/validation.yml')]);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'bsCoreTranslationBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/Core/TranslationBundle'),
                    'namespace' => 'bs\\Core\\TranslationBundle',
                ],
                'bsCoreUsersBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/Core/UsersBundle'),
                    'namespace' => 'bs\\Core\\UsersBundle',
                ],
                'bsCoreAdminBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/Core/AdminBundle'),
                    'namespace' => 'bs\\Core\\AdminBundle',
                ],
                'bsIDPArchiveBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/IDP/ArchiveBundle'),
                    'namespace' => 'bs\\IDP\\ArchiveBundle',
                ],
                'bsIDPBackofficeBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/IDP/BackofficeBundle'),
                    'namespace' => 'bs\\IDP\\BackofficeBundle',
                ],
                'bsIDPDashboardBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/bs/IDP/DashboardBundle'),
                    'namespace' => 'bs\\IDP\\DashboardBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'bsCoreTranslationBundle' => 'bs\\Core\\TranslationBundle\\bsCoreTranslationBundle',
                'bsCoreUsersBundle' => 'bs\\Core\\UsersBundle\\bsCoreUsersBundle',
                'bsCoreAdminBundle' => 'bs\\Core\\AdminBundle\\bsCoreAdminBundle',
                'bsIDPArchiveBundle' => 'bs\\IDP\\ArchiveBundle\\bsIDPArchiveBundle',
                'bsIDPBackofficeBundle' => 'bs\\IDP\\BackofficeBundle\\bsIDPBackofficeBundle',
                'bsIDPDashboardBundle' => 'bs\\IDP\\DashboardBundle\\bsIDPDashboardBundle',
            ...
            'secret' => 'e05e686ea8026f0bdbd91b6839f175aa80ce9baa',
            'database_driver' => 'pdo_mysql',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e05e686ea8026f0bdbd91b6839f175aa80ce9baa',
            ...
            'assetic.bundles' => [
                0 => 'bsIDPArchiveBundle',
                1 => 'bsCoreUsersBundle',
                2 => 'bsIDPBackofficeBundle',
                3 => 'bsIDPDashboardBundle',
            ],
            ...
            'assetic.node.bin' => '/opt/homebrew/bin/node',
            'assetic.ruby.bin' => '/usr/bin/ruby',
            'assetic.sass.bin' => '/opt/homebrew/bin/sass',
