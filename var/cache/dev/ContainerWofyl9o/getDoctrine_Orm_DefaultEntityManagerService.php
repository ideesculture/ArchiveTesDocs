...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/bs/Core/TranslationBundle/Entity'), 1 => ($this->targetDirs[3].'/src/bs/Core/UsersBundle/Entity'), 2 => ($this->targetDirs[3].'/src/bs/Core/AdminBundle/Entity'), 3 => ($this->targetDirs[3].'/src/bs/IDP/ArchiveBundle/Entity'), 4 => ($this->targetDirs[3].'/src/bs/IDP/BackofficeBundle/Entity'), 5 => ($this->targetDirs[3].'/src/bs/IDP/DashboardBundle/Entity')]);

$b->addDriver($c, 'bs\\Core\\TranslationBundle\\Entity');
$b->addDriver($c, 'bs\\Core\\UsersBundle\\Entity');
$b->addDriver($c, 'bs\\Core\\AdminBundle\\Entity');
$b->addDriver($c, 'bs\\IDP\\ArchiveBundle\\Entity');
$b->addDriver($c, 'bs\\IDP\\BackofficeBundle\\Entity');
$b->addDriver($c, 'bs\\IDP\\DashboardBundle\\Entity');

$a->setEntityNamespaces(['bsCoreTranslationBundle' => 'bs\\Core\\TranslationBundle\\Entity', 'bsCoreUsersBundle' => 'bs\\Core\\UsersBundle\\Entity', 'bsCoreAdminBundle' => 'bs\\Core\\AdminBundle\\Entity', 'bsIDPArchiveBundle' => 'bs\\IDP\\ArchiveBundle\\Entity', 'bsIDPBackofficeBundle' => 'bs\\IDP\\BackofficeBundle\\Entity', 'bsIDPDashboardBundle' => 'bs\\IDP\\DashboardBundle\\Entity']);
