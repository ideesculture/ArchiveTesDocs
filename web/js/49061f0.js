...
var documentnature_id = window.IDP_DATA.idp_documentnature_id;
var all_services = [];
$_translations = null;
...
function setLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_documentnatures_links_set,
		data: { documentNatureId: documentnature_id, serviceId: row['id'] },
		cache: false,
...
function unsetLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_documentnatures_links_unset,
		data: { documentNatureId: documentnature_id, serviceId: row['id'] },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
...
function setAllLinkSelected( ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_documentnatures_links_set,
		data: { documentNatureId: documentnature_id, serviceId: -1 },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
		},
...
function loadDocumentNatureLink( $data ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_documentnatures_links_list,
		data: { documentNatureId: documentnature_id },
		cache: false,
