...
var description2_id = window.IDP_DATA.idp_description2_id;
var all_services = [];
...
function setLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_descriptions2_links_set,
		data: { description2Id: description2_id, serviceId: row['id'] },
		cache: false,
...
function unsetLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_descriptions2_links_unset,
		data: { description2Id: description2_id, serviceId: row['id'] },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
...
function setAllLinkSelected( ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_descriptions2_links_set,
		data: { description2Id: description2_id, serviceId: -1 },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
		},
...
function loadDescription2Link( $data ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_descriptions2_links_list,
		data: { description2Id: description2_id },
		cache: false,
