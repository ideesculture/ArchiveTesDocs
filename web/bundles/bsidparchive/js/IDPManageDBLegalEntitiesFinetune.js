...
function setLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_legalentities_links_set,
		data: { legalEntityId: legalentity_id, serviceId: row['id'] },
		cache: false,
...
function unsetLinkSelected( row ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_legalentities_links_unset,
		data: { legalEntityId: legalentity_id, serviceId: row['id'] },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
...
function setAllLinkSelected( ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_legalentities_links_set,
		data: { legalEntityId: legalentity_id, serviceId: -1 },
		cache: false,
		success: function( data, status ){
			$("#waitAjax").hide();
		},
...
function loadLegalEntityLink( $data ){
	...
	$.ajax({
		type: "GET",
		url: window.ARCHIVIST_JSON_URLS.bs_idp_archivist_json_legalentities_links_list,
		data: { legalEntityId: legalentity_id },
		cache: false,
