 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="bs\IDP\BackofficeBundle\Entity\IDPDescriptions2Repository")
 */
class IDPDescriptions2
{
    /**
     * @var integer
     *
	...
	/**
	 * @ORM\ManyToMany( targetEntity="IDPServices", inversedBy="descriptions2" )
	 **/
	private $services;
