 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="bs\IDP\BackofficeBundle\Entity\IDPBudgetCodesRepository")
 */
class IDPBudgetCodes
{
	/**
	 * @var integer
	 *
	...
	/**
	 * @ORM\ManyToMany( targetEntity="IDPServices", inversedBy="budgetCodes" )
	 **/
	private $services;
